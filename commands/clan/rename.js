...
module.exports = {
    ...
    async execute(message, args, clan, member) {
        ...
        if (memberClans === null) {
            message.channel.send(`You're not in a clan. Use **${prefix}help** if you want to know how to create a clan.`);
        }
        ...
        if (!args.length) {
            ...
            message.channel.send(`You have to provide a string in order to rename your clan.`)
        }
